...
<htmL>
    <body style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
        <h1 style="font-weight: 600; text-align: center; background-color: #16a085; color: #fff; padding: 10px 0px; border-radius:15px;">Fruits</h1>
        <table style=" border-collapse: collapse; border: 1px solid #bdc3c7; border-radius: 15px 15px; overflow:hidden; background-repeat:no-repeat; width:100% ; margin:0; box-shadow: 2px 2px 12px rgba(0, 0, 0, 0.2), -1px -1px 8px rgba(0, 0, 0, 0.2);  ">
            ...
            <tr style="transition: all .2s ease-in; cursor: pointer;">
                ...
                <td style="padding: 12px; text-align: Center; border-bottom: 1px solid #ddd; background-color: #29AB87;"><a href="#" style="color:white" ><b>Add to Cart</b></a></td>
            </tr>
            </xsl:for-each>
            </tbody>
        </table>
